 ...
 */
public class EntityRTreeProximity implements Proximity<Vector2> {
	Entity owner;
	float radius;
	final float[] size;
	Class<?> filterType;
	EntityRTree entities;
	
	public EntityRTreeProximity(Entity owner, EntityRTree entities, float radius) {
		this.owner = owner;
	...
	public EntityRTreeProximity setFilterType(Class<?> c) {
		filterType = c;
		return this;
	}
