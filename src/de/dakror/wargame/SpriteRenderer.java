...
public class SpriteRenderer {
	...
	public SpriteRenderer() {
		...
		indices.position(0);
		program = MainActivity.instance.createProgram("shader/sprite.vs", "shader/sprite.fs");
		...
		uPalettes = new int[9];
		for (int i = 0; i < 8; i++)
			palettes[i] = MainActivity.instance.loadTexture("palettes/color" + i + ".png");
		palettes[8] = MainActivity.instance.loadTexture("palettes/terrain.png");
	}
